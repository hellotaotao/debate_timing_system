(function countdownTimerFirst() {
    'use strict';
    var duration = moment.duration(first_duration, "minutes");
    var time_left=duration;
    //declare
    var output = document.getElementById('stopwatch-first-timer');
    var toggle = document.getElementById('stopwatch-first-toggle');
    var clear = document.getElementById('stopwatch-first-clear');
    var running = false;
    var paused = false;
    var timer;
    var ding_played;
