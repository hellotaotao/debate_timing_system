(function countdownTimerThirdAsk() {
    'use strict';
    var duration = moment.duration(third_ask_duration, "minutes");
    var time_left=duration;
    //declare
    var output = document.getElementById('stopwatch-third-ask-timer');
    var toggle = document.getElementById('stopwatch-third-ask-toggle');
    var clear = document.getElementById('stopwatch-third-ask-clear');
    var running = false;
    var paused = false;
    var timer;
    var ding_played;
