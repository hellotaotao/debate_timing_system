(function countdownTimerThirdConclude() {
    'use strict';
    var duration = moment.duration(third_conclude_duration, "minutes");
    var time_left=duration;
    //declare
    var output = document.getElementById('stopwatch-third-conclude-timer');
    var toggle = document.getElementById('stopwatch-third-conclude-toggle');
    var clear = document.getElementById('stopwatch-third-conclude-clear');
    var running = false;
    var paused = false;
    var timer;
    var ding_played;
