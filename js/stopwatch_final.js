(function countdownTimerFinal() {
    'use strict';
    var duration = moment.duration(final_duration, "minutes");
    var time_left=duration;
    //declare
    var output = document.getElementById('stopwatch-final-timer');
    var toggle = document.getElementById('stopwatch-final-toggle');
    var clear = document.getElementById('stopwatch-final-clear');
    var running = false;
    var paused = false;
    var timer;
    var ding_played;
